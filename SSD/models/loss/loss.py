...
class MultiBoxLoss(nn.Module):
    ...
    def __init__(self, cfg,
        ...
        self.threshold = cfg['Train']['match_thresh']
        self.negpos_ratio = cfg['Train']['neg_pos']
        self.neg_overlap = cfg['Train']['neg_thresh']
...
if __name__ == '__main__':
    ...
    loss = MultiBoxLoss(cfg=cfg,
                        use_gpu=False)
    p = (torch.randn(1, 100, 4), torch.randn(1, 100, 81), torch.randn(100, 4))
    t = torch.randn(1, 10, 4)
    tt = torch.randint(80, (1, 10, 1))
