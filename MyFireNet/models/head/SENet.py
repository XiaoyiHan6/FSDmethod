...
class SEConv(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.globalAvgPool = nn.AvgPool2d(kernel_size=(1, 1), stride=1)
        self.fc1 = nn.Flatten()
        self.fc2 = nn.Flatten()
    ...
    def forward(self, x):
        ...
        out = out.view(out.size(0), planes, h, w)
...
def se_resnet_18(pretrained=False, **kwargs):
    ...
    """
    model = SENet(SEConv, [2, 2, 2, 2], **kwargs)
    return model
...
def se_resnet_34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = SENet(SEConv, [3, 4, 6, 3], **kwargs)
    return model
