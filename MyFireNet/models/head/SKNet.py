...
class SKConv(nn.Module):
    def __init__(self, features, WH=32, M=2, G=8, r=2, stride=1, L=32):
        """ Constructor
        Args:
...
class SKUnit(nn.Module):
    def __init__(self, in_features, out_features, WH=32, M=2, G=8, r=2, mid_features=None, stride=1, L=32):
        """ Constructor
        Args:
